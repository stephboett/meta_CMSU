...
```
    ...
    ## sigma^2.2  0.0015  0.0389      5     no      su_mod 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 192) = 4331.4593, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 1:4):
    ## QM(df = 4) = 31.1798, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                          estimate      se    zval    pval    ci.lb   ci.ub   ​ 
    ## measure_modcase records    0.0484  0.0469  1.0331  0.3016  -0.0434  0.1403    
    ## measure_modother           0.0318  0.0743  0.4285  0.6683  -0.1138  0.1775    
    ## measure_modself-report     0.0856  0.0344  2.4851  0.0130   0.0181  0.1531  * 
    ## I(sqrt(vi))                0.9607  0.4795  2.0033  0.0451   0.0208  1.9005  * 
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## 
    ##             estim    sqrt  nlvls  fixed      factor 
    ## sigma^2.1  0.0069  0.0830     32     no  control_id 
    ## sigma^2.2  0.0015  0.0389      5     no      su_mod 
    ## 
    ## Test for Residual Heterogeneity:
    ...
    ## 
    ## Test of Moderators (coefficients 1:4):
    ## QM(df = 4) = 31.6357, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                          estimate      se    zval    pval    ci.lb    ci.ub​ 
    ## measure_modcase records    0.0780  0.0405  1.9238  0.0544  -0.0015   0.1574 
    ## measure_modother           0.0634  0.0694  0.9131  0.3612  -0.0726   0.1994 
    ## measure_modself-report     0.1119  0.0272  4.1060  <.0001   0.0585   0.1653 
    ## vi                         6.4889  3.4433  1.8845  0.0595  -0.2598  13.2376 
    ##  
...
```
    ...
    ##          r      ci.lb      ci.ub 
    ## 0.25342513 0.01690571 0.46308548
